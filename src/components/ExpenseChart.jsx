...
export function ExpenseChart() {
    ...
    return (
      <div className="bg-zinc-900 p-4 my-2">
        <div className="h-full flex items-center justify-center w-full flex-col">
          ...
          <h1 className="text-3xl font-bold my-2"><center>No data yet</center></h1>
        </div>
      </div>
    );
  }
  if(totalExpenses>totalIncomes){
    return(
      <div className="bg-zinc-900 p-5 my-4">
        <div className="h-full flex items-center justify-center w-full flex-col">
          <BsPieChartFill className="text-9xl items-center justify-center" />
          <h1 style={{color:'red'}} className="text-3xl font-bold my-2"><center>You are in Loss</center></h1>
        </div>
      </div>
    );
  }
